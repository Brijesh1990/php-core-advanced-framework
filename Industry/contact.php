...
<head>
	<title>Steam Engine an Industrial Category Bootstrap Responsive Web Template | Contact :: w3layouts</title>
	<!--/tags -->
...
<body>
   ...
   ?>
	...
	<div class="inner_content_info_agileits">
		<div class="container">
			<h3 class="heading-agileinfo">Contact Us<span>That performs mechanical work using </span></h3>
					...
					<div class="address-grid">
						...
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<h6>Telephone</h6> <p>+1 (100)222-23-33</p>
							</div>
						...
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<h6>Mail</h6> <p><a href="mailto:info@example.com">info@example.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<h6>Location</h6><p>8088 USA, Honey block,New York City.</p>
							</div>
							<div class="clearfix"> </div>
						</div>
